...
1. **Instalación de Astro**: Creé mi proyecto y configuré mis cuentas en línea.
2. **Creación de páginas**: Aprendí a hacer páginas con archivos `.astro` en `src/pages/`.
3. **Creación de publicaciones**: ¡Esta es mi primera publicación! Ya tengo páginas de Astro y publicaciones en Markdown.
